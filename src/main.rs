...
//Convert DatabaseConfig into PgConnectOptions which is used to connect to postgres.
...
async fn main() -> Result<()> {
    ...
    let app = Router::new()
        ...
        //Register db connection pool to router state
        //to enable handlers to use it.
        .with_state(conn_pool);

    //Create a new socket address from localhost and port 8080.
    let addr = SocketAddr::new(Ipv4Addr::LOCALHOST.into(), 8080);

    //Create a new TcpListener bound to the address defined above.
